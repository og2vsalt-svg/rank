...
const items = [
  ...
  { title: 'studio', body: 'resize a still locally and download a png. stays on this device.' },
  { title: 'folio', body: 'publish a tiny public card as html. not a vault clone.' },
  { title: 'relay', body: 'room codes + notes that stay on this device so you can hand someone a phrase.' },
  { title: 'mirror', body: 'clone an existing /s drop into a fresh id when the old link is messy.' },
