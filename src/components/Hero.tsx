    ...
    <section className="relative pt-28 pb-20 px-5 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-12">
          ...
          <button onClick={() => navigate('iris')} className="inline-flex px-5 py-2.5 rounded-full glass text-neutral-300 text-sm font-medium hover:text-white transition">iris</button>
          <button onClick={() => navigate('pallet')} className="inline-flex px-5 py-2.5 rounded-full glass text-neutral-300 text-sm font-medium hover:text-white transition">pallet</button>
          <button onClick={() => navigate('mirage')} className="inline-flex px-5 py-2.5 rounded-full glass text-neutral-300 text-sm font-medium hover:text-white transition">mirage</button>
