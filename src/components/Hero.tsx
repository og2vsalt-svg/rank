    ...
    <section className="relative pt-28 pb-20 px-5 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.12 }} className="text-neutral-400 text-lg leading-relaxed max-w-xl mb-8">
          a quiet vault for clips, docs, and dumps. preview in place, sort into folders, flip a file public when you need a link. no size lock. just a heads up if the tab might lag. new desk: solstice hashes a file before it goes public.
        </motion.p>
        ...
        <div className="flex flex-wrap gap-3 mb-12">
          ...
          <button onClick={() => navigate('solstice')} className="inline-flex px-5 py-2.5 rounded-full glass text-neutral-300 text-sm font-medium hover:text-white transition">solstice</button>
