    ...
    <nav className="fixed top-0 inset-x-0 z-50 glass">
          ...
          {isLoggedIn ? (
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="text-[13px] text-neutral-400 hover:text-white px-2.5 py-1.5 rounded-full transition-colors"
              >
                log in
              </button>
              <button
      ...
      <div
        className={`border-t border-white/5 overflow-hidden transition-all duration-300 ease-out ${
          menuOpen ? 'max-h-[min(70vh,560px)] opacity-100' : 'max-h-0 opacity-0'
        }`}
      >
