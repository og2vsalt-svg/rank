...
export default function VaultPage() {
  ...
  const {
    ...
    collections, addCollection, setCollection,
  } = useVault();
  ...
  const shown = useMemo(() => {
    ...
    return list;
  }, [source, query, folder, tag, onlyStarred, showTrash, sort, kind, collection]);
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      ...
      if (e.key === 'Escape') { setPreview(null); setShowKeys(false); }
